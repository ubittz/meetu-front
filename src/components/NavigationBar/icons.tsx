...
export function ActiveHomeIcon(props: DefaultIconProps) {
  return (
    <svg width='19' height='23' viewBox='0 0 19 23' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
      <path
        d='M18.4952 22.9965H0.508203C0.226997 22.9965 0 22.7617 0 22.4708V9.58428C0 9.4441 0.0542083 9.30742 0.152461 9.20929L9.11377 0.149823C9.31027 -0.049941 9.62536 -0.049941 9.82186 0.149823L18.8475 9.20929C18.9458 9.30742 19 9.4441 19 9.58779V22.4743C19 22.7652 18.773 23 18.4918 23L18.4952 22.9965ZM1.01641 21.9451H17.987V9.80507L9.4729 1.25729L1.01641 9.80507V21.9451Z'
        fill='#212121'
      />
    </svg>
  );
...
export function ActiveFindClassIcon(props: DefaultIconProps) {
  return (
...
export function InactiveFindClassIcon(props: DefaultIconProps) {
  return (
    <svg width='26' height='23' viewBox='0 0 26 23' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
      <path
...
export function ActiveMyPageIcon(props: DefaultIconProps) {
  return (
...
export function InactiveMyPageIcon(props: DefaultIconProps) {
  return (
    <svg width='24' height='28' viewBox='0 0 24 28' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
      <path
        d='M11.9801 12.72C15.2165 12.72 17.8401 10.0964 17.8401 6.86C17.8401 3.62361 15.2165 1 11.9801 1C8.74373 1 6.12012 3.62361 6.12012 6.86C6.12012 10.0964 8.74373 12.72 11.9801 12.72Z'
